...
contract PredictionMarketCurrencyQuadratic is Ownable, ReentrancyGuard {
    enum MarketOutcome {
        UNRESOLVED,
        OPTION_A,
        OPTION_B
    ...
    struct Market {
        ...
        mapping(address => uint256) optionAVoteCount;
        mapping(address => uint256) optionBVoteCount;
    ...
    function createMarket(
        ...
        // Transfer tokens for initial liquidity
